...
const My=()=>{
    ...
    <>
        ...
        <section id="nfts" className="flex flex-wrap sm:justify-start justify-center w-full feedback-container relative z-[1]">
          ...
          <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[300px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
            <h3 className="font-poppins font-semibold text-white text-[18px] leading-[23.4px] mb-1">
              Please provide us with details to Send your NFT
            </h3>
            <p className="font-poppins font-normal text-[18px] leading-[32.4px] text-white my-10">
              <label class="relative block p-3 border-2 border-gray-200 rounded-lg" for="name">
              <input
            ...
            <button onClick={transfer} class="inline-block p-[2px] rounded bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 hover:text-white active:text-opacity-75 focus:outline-none focus:ring" >
            <span class="block px-8 py-3 text-sm font-medium bg-white rounded-sm hover:bg-transparent">
              Send
            </span>
            </button>
          ...
          <div className="flex justify-between flex-col px-10 py-12 rounded-[20px]  max-w-[300px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
            <h3 className="font-poppins font-semibold text-white text-[18px] leading-[23.4px] mb-1">
              Please provide us with details to Send and Unpack the Tokeniz on Receiver's wallet
            </h3>
            <p className="font-poppins font-normal text-[18px] leading-[32.4px] text-white my-10">
              <label class="relative block p-3 border-2 border-gray-200 rounded-lg" for="name">
              <input
            ...
            <button onClick={transferAndUnpack} class="inline-block p-[2px] rounded bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 hover:text-white active:text-opacity-75 focus:outline-none focus:ring" >
            <span class="block px-8 py-3 text-sm font-medium bg-white rounded-sm hover:bg-transparent">
              Transfer And Unpack
            </span>
            </button>
